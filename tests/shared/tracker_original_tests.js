/* Tracker tests from 41dc9b, s/Meteor.Computation/Meteor.Computation/g */
/* Shows that Meteor.Computation is only a superset of Tracker.autorun */
Tinytest.add('tracker compatibility - run', function (test) {
  var d = new Tracker.Dependency;
  var x = 0;
  var handle = Meteor.Computation(function (handle) {
    d.depend();
    ++x;
  });
  test.equal(x, 1);
  ...
  Meteor.Computation(function (internalHandle) {
    d.depend();
    ++x;
    if (x == 6)
      internalHandle.stop();
...
Tinytest.add("tracker - nested run", function (test) {
  ...
  var c1 = Meteor.Computation(function () {
    a.depend();
    buf += 'a';
    Meteor.Computation(function () {
      b.depend();
      buf += 'b';
      Meteor.Computation(function () {
        c.depend();
        buf += 'c';
        var c2 = Meteor.Computation(function () {
          d.depend();
          buf += 'd';
          Meteor.Computation(function () {
            e.depend();
...
Tinytest.add("tracker - flush", function (test) {
  ...
  var c1 = Meteor.Computation(function (c) {
    buf += 'a';
  ...
  var c2 = Meteor.Computation(function (c) {
    buf += 'a';
    // invalidate first time
    if (c.firstRun)
      c.invalidate();
  ...
  var c3 = Meteor.Computation(function (c) {
    buf += 'a';
    // invalidate first time
    if (c.firstRun)
      c.invalidate();
  ...
  var c4 = Meteor.Computation(function (c) {
    c4 = c;
    buf += 'b';
  });
...
Tinytest.add("tracker - onInvalidate", function (test) {
  ...
  test.equal(buf, '*');
  Meteor.Computation(function (me) {
...
Tinytest.addAsync('tracker - no infinite recomputation', function (test, onComplete) {
  var reran = false;
  var c = Meteor.Computation(function (c) {
    if (! c.firstRun)
      reran = true;
    c.invalidate();
  });
...
testAsyncMulti('tracker - Meteor.Computation, onError option', [function (test, expect) {
  var d = new Tracker.Dependency;
  var c = Meteor.Computation(function (c) {
    d.depend();
